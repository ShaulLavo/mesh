...
// StatFile is an optional interface for handles returned by FileReader,
// FileWriter, OpenFileWriter, and FileLister. When implemented, Fstat uses
// the open handle's Stat method instead of looking up its pathname.
